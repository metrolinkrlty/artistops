...
type Doc = { id: string; songTitle: string; type: string; title: string; parties: string[]; expiresAt: string | null; status: string };
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex gap-2 flex-wrap">
            {["all", "split_sheet", "license", "recording_contract", "distribution_agreement"].map((t) => (
        ...
        <div className="bg-[#1a1d27] border border-[#2a2d3a] rounded-xl overflow-hidden">
          <table className="w-full text-sm">
            ...
            <tbody>
              ...
              {filteredDocs.length === 0 && <tr><td colSpan={6} className="px-6 py-10 text-center text-[#8b8fa8] text-sm">No documents.</td></tr>}
            </tbody>
          </table>
        </div>
      </div>
